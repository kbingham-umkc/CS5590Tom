...
public class Tetris extends JFrame {
	...
	private static final long serialVersionUID = -4722429764792514382L;			// UID
	private static final long FRAME_TIME = 1000L / 50L;							// milliseconds per frame
	private static final int TYPE_COUNT = TileType.values().length;				// Number of Tile Pieces
